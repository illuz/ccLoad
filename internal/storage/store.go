...
type Store interface {
	...
	UpdateTokenStats(ctx context.Context, tokenHash string, isSuccess bool, isBillable bool, duration float64, isStreaming bool, firstByteTime float64, promptTokens int64, completionTokens int64, cacheReadTokens int64, cacheCreationTokens int64, costUSD float64) error
