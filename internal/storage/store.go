...
type Store interface {
	...
	GetModelUsage(ctx context.Context, since, until time.Time, filter *model.LogFilter) ([]model.ModelUsageStat, error)
	...
	GetRecentCacheStats(ctx context.Context, requestLimit int) (*model.RecentCacheStats, error)
	GetRPMStats(ctx context.Context, startTime, endTime time.Time, filter *model.LogFilter, isToday bool) (*model.RPMStats, error)
	GetCodexGuardSummary(ctx context.Context, startTime, endTime time.Time) (*model.CodexGuardSummary, error)
	...
	UpdateTokenStats(ctx context.Context, tokenHash string, isSuccess bool, isBillable bool, duration float64, isStreaming bool, firstByteTime float64, promptTokens int64, completionTokens int64, cacheReadTokens int64, cacheCreationTokens int64, costUSD float64, effectiveCostUSD float64) error
