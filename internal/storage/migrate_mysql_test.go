...
func TestMySQL(t *testing.T) {
	...
	t.Run("EnsureColumns_AddNew", func(t *testing.T) {
		...
		// 验证 auth_tokens 表的新列
		authTokenCols := []string{"plain_token", "allowed_models", "cost_used_microusd", "cost_limit_microusd", "daily_cost_used_microusd", "daily_cost_limit_microusd", "daily_cost_day_key", "daily_limit_double_day_key"}
