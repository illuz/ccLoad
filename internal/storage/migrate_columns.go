...
func ensureAuthTokensDailyLimitTriple(ctx context.Context, db *sql.DB, dialect Dialect) error {
	return ensureColumn(ctx, db, dialect, "auth_tokens", "daily_limit_triple_day_key",
		"INT NOT NULL DEFAULT 0",
		"INTEGER NOT NULL DEFAULT 0")
}
